...
void test_2()  //RAINBOW 
//https://github.com/FastLED/FastLED/wiki/Pixel-reference - CHSV color scale
{
  FastLED.setBrightness(10);
  for (int i = 0; i < NUM_LEDS; i++ ) {
    leds[i] = CHSV(counter + i * 2, 255, 255); // CHSV(hue, saturation, value)
  }
  counter++;        // 0 to 255 (byte data type)
  FastLED.show();
  delay(5);         // moving speed
}

void test_3() //CHSV COLOR RUNNING DOT 
...
void test_4() //RGB COLOR RUNNING DOT 
// https://github.com/FastLED/FastLED/wiki/Pixel-reference - color set
{
    FastLED.setBrightness(255);
   // Move a single white led 
